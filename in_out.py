...
def in_out():
    ...
    while True:
        ...
        save_path=r'C:\Users\akash\Desktop\Mini-Project\Smart-Surveillance-System\visitors\in.jpg'
        ...
        if right == "" and left == "":
            if x > 500:
                ...
                if x < 200:
                    ...
                    try:
                        filename = f"visitors/out/{datetime.now().strftime('%y-%m-%d-%H:%M:%S')}.jpg"
